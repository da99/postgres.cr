...
describe Postgres::Driver, "encoder" do
  ...
  test_insert_and_read "point", Postgres::Geo::Point.new(1.2, 3.4)
  if Helper.db_version_gte(9, 4)
    test_insert_and_read "line", Postgres::Geo::Line.new(1.2, 3.4, 5.6)
  end
  test_insert_and_read "circle", Postgres::Geo::Circle.new(1.2, 3.4, 5.6)
  test_insert_and_read "lseg", Postgres::Geo::LineSegment.new(1.2, 3.4, 5.6, 7.8)
  test_insert_and_read "box", Postgres::Geo::Box.new(1.2, 3.4, 5.6, 7.8)
  test_insert_and_read "path", Postgres::Geo::Path.new([
    Postgres::Geo::Point.new(1.2, 3.4),
    Postgres::Geo::Point.new(5.6, 7.8),
  ], closed: false)
  test_insert_and_read "path", Postgres::Geo::Path.new([
    Postgres::Geo::Point.new(1.2, 3.4),
    Postgres::Geo::Point.new(5.6, 7.8),
  ], closed: true)
  test_insert_and_read "polygon", Postgres::Geo::Polygon.new([
    Postgres::Geo::Point.new(1.2, 3.4),
    Postgres::Geo::Point.new(5.6, 7.8),
  ])
